...
public final class DobarmanTOOLR extends AppCompatActivity {
    public Activity activity = this;

    public final void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(R.layout.ll_dobarmantoo_r);
            ...
            public void onClick(View view) {
                PanichaMV9.dis_ATinter(activity, new PanichaInter.Ivorycallback() {
                    ...
                    public void onTasknext() {
                        Intent intent = new Intent(DobarmanTOOLR.this, DobarmanTOOLS.class);
