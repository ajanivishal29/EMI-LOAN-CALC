...
import com.financecalculator.emicalcutator.meghachem.DOBARFIRSTActivity;
...
public final class DobarmanTOOLT extends AppCompatActivity {
    public Activity activity = this;

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(R.layout.ll_dobarmantoo_t);
            ...
            public void onClick(View view) {
                PanichaMV9.dis_ATinter(activity, new PanichaInter.Ivorycallback() {
                    ...
                    public void onTasknext() {
                        Intent intent = new Intent(DobarmanTOOLT.this, DOBARFIRSTActivity.class);
